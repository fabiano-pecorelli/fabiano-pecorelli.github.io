    ...
    <section class="content">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <div class="top-description-text" style="text-align: left; margin: 30px 0 0 0;">
                        <h3>15th International Workshop on Software Clones</h3>
                        <p><b>Home page:</b><span>&nbsp;<a target="_blank" href="https://iwsc2021.github.io/">https://iwsc2021.github.io/</a></span></p>
                        <hr class="lineHr">
			...
			Software clones are often a result of copying and pasting as an act of ad-hoc reuse by programmers, and can occur at many levels, from simple statement sequences to blocks, methods, classes, source files, subsystems, models, architectures and entire designs, and in all software artifacts (code, models, requirements or architecture documentation, etc.). Software clone research is of high relevance for software engineering research and practice today.
                        ...
                        <p>A partial list of the topics is as follows (this list is by no means exhaustive, and it is a goal of the workshop to further extend it):</p>
                        <ul>
			...
			<p style="text-align: justify;">
                		...
                		<ul>
                    			<li>Abstract submission deadline: TBD</li>
                            	<li>Paper submission deadline: TBD</li>
                    			<li>Notifications: TBD</li>
                    			<li>Camera Ready: TBD</li>
                		</ul>
                	</p>
			<p style="text-align: justify;">
			<strong>For further information and submission details visit the workshop's official page <a href="https://iwsc2021.github.io">here</a></strong>
			</p>
                </div>
            </div>
        </div>
