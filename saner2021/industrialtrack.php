        ...
        <div class="row">
            <div class="col-md-12">
                <p style="text-align: justify;">
                    The 28th edition of the International Conference on Software Analysis, Evolution, and Reengineering (SANER’21) will feature an Industry track. The aim of this track is to bring together practitioners and researchers for an exchange of ideas, problems, and results. It provides a platform for people in industry and academia to interact with one another. The papers in the Industry track follow the general topics specified in the SANER 2021 research track.
                </p>
                <p style="text-align: justify;">
                ...
                <p style="text-align: justify; margin-top: 15px;">
                    <strong>Important note:</strong> SANER 2021 follows a full double-blind review process.​ Submissions that do not adhere to these limits or that violate the formatting guidelines will be desk-rejected without review.
                </p>
                <br>
