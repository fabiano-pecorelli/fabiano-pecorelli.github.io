        ...
        <div class="row">
            <div class="col-md-12">
                <p style="text-align: justify;">
                    The 28th edition of the International Conference on Software Analysis, Evolution, and Reengineering (SANER’21) would like to encourage researchers to (1) reproduce results from previous papers and (2) publish studies with important and relevant negative or null results (results which fail to show an effect, yet demonstrate the research paths that did not pay off).
                </p>
                <p style="text-align: justify;">
                    We would also like to encourage the publication of the negative results or reproducible aspects of previously published work (in the spirit of journal-first submissions). This previously published work includes accepted submissions for the 2021 SANER main track.
                </p>
                ...
                <p style="text-align: justify;">
                    <br>
                    <strong>Important note: the RENE track of SANER 2021 DOES NOT FOLLOW a full double-blind review process.</strong>
                </p>
                <p style="text-align: justify;">
                    <br>
                ...
                <ul>
                    ...
                    <li>Paper submission deadline: <font color="red">November 19, 2020</font></li>
