        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <div class="top-description-text" style="text-align: left; margin: 30px 0 0 0;">
                        <h3>4th International Workshop on Validation, Analysis and Evolution of Software Tests</h3>
                        <p><b>Home page:</b><span>&nbsp;<a target="_blank" href="http://vst2021.scch.at/">http://vst2021.scch.at/</a></span></p>
                        <hr class="lineHr">
			...
			<p style="text-align: justify;">
                		...
                		<ul>
                    			...
                    			<li>Notifications: January TBD</li>
                    			<li>Camera Ready: January TBD</li>
                		</ul>
                	</p>
			<p style="text-align: justify;">
			<strong>For further information and submission details visit the workshop's official page <a href="http://vst2021.scch.at/">here</a></strong>
			</p>
                </div>
            </div>
        </div>
