        ...
        <div class="row">
            <div class="col-md-12">
                <p style="text-align: justify;">
                    Following SANER '19 and '20 success, we have partnered with several software engineering journals to incorporate
                ...
                <p style="text-align: justify;">
                    <span>The participating journals that partner with SANER are the following:</span>
                <ul>
                    <li><a target="_blank" href="https://link.springer.com/journal/10664">Empirical Software Engineering</a> (Springer)</li>
                    <li><a href="https://www.journals.elsevier.com/journal-of-systems-and-software/" target="_blank">Journal
                            of Systems and Software</a> (Elsevier)
                    </li>
		    <li><a href="https://www.journals.elsevier.com/information-and-software-technology/" target="_blank">Information and Software Technology</a> (Elsevier)
                    </li>
		    <li><a target="_blank" href="https://link.springer.com/journal/11219">Software Quality Journal</a> (Springer)</li>
                    <li><a href="http://onlinelibrary.wiley.com/journal/10.1002/(ISSN)2047-7481" target="_blank">Journal
                            of Software: Evolution and Process</a> (Wiley)
                    </li>
		    <li><a href="https://www.journals.elsevier.com/science-of-computer-programming/" target="_blank">Science of Computer Programming</a> (Elsevier)
                    </li>
		    <li><a href="https://www.computer.org/csdl/magazine/so" target="_blank">IEEE Software</a> (IEEE Software Society)
                    </li>
                </ul>
                </p>
                <br>
                ...
                <p style="text-align: justify; margin-top: 15px;">
                    ...
                    <ul>
                        <li>Be accepted in one of the participating journals after June 1, 2018 and before the J1C2 submission deadline.</li>
                        ...
                        <li>Not been presented at or under consideration for any journal-first program of another conference (or a past edition of this conference).</li>
			<li>Be a peer-reviewed article (e.g., letters to the editor are not considered eligible).</li>
                    </ul>
                </p>
                <br>
                ...
                <p style="text-align: justify; margin-top: 15px;">
                    The accepted journal-first papers will be listed in the conference program. Full journal-first manuscripts are published through the journals and will not be part of the SANER proceedings.
                </p>
                <p style="text-align: justify;">
                    <br>
                    <strong>Important Dates</strong>
                <ul>
                    <li>Submission: <font color="red">TBD</font></li>
                    <li>Notification: <font color="red">TBD</font></li>
                    <li>Submission Page: <a href="https://easychair.org/conferences/?conf=saner2020" target="_blank">TBD</a></li>
                </ul>
                </p>
            </div>
        </div>
                ...
                foreach ($json['commiteeMembers']['journalTrack'] as $key => $value) {
                    ...
                    <div class="col-md-4">
                        <?php if (!is_null($value['website'])) { ?>
                            <a href="<?php echo $value['website'] ?>" target="_blank"><?php echo $value['name'] ?></a><?php if ($value['cochair'] == true) { echo ' <span style="font-size: 18px;">(Chair)</span>';} ?>
                        <?php } else { ?>
